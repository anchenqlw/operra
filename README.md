...
```bash
curl -fL https://github.com/anchenqlw/operra/releases/download/v0.1.2-unsigned.3/install-operra-0.1.2-unsigned.3.sh -o /tmp/install-operra.sh
echo "1b081677cf662055d802939e273de2b4062b70a4f0c797a38e617b33ebd16900  /tmp/install-operra.sh" | shasum -a 256 -c -
...
- 修复干净 Mac 上 GitHub/QCA HTTPS 因内置 Python 缺少 CA 根证书而出现的 `CERTIFICATE_VERIFY_FAILED`；安装包现自带可信 CA，发布前会在无 SSL 环境变量的真包中验证两项连接；
